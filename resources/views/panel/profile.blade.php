    ...
    <div class="container-fuild pt-4 px-4">
        <div class="bg-light rounded-top p-5 shadow-sm">
            <div class="bg-white p-4">
                <form action="{{route('profileupdata')}}" method="post" class="form-d" id="form">
                    @csrf
                    <div class="container">
                                ...
                                <div class="part1 p-5">
                                    <div class="d-flex justify-content-between col-lg-12 taraz">
                                        <div class="control-form form-group d-block col-lg-5 col-md-12 col-sm-10 col-7">
                                            ...
                                            <input type="text" name="school_name" value="{{ $user->school_name }}"
                                                class="form-control shadow-sm border-0" id="schoolName"
                                        ...
                                        <div class="control-form form-group d-block col-lg-5 col-md-12 col-sm-10 col-7">
                                            ...
                                            <input type="text" name="address" value="{{ $user->address }}"
                                                class="form-control shadow-sm border-0" id="address"
                                    ...
                                    <div class="d-flex justify-content-between col-lg-12 taraz">
                                        <div class="control-form form-group d-block col-lg-5 col-md-6 col-sm-10 col-7">
                                            ...
                                            <input type="tel" name="phone" value="{{ $user->phone }}"
                                                class="form-control shadow-sm border-0" id="numSchool"
                                        ...
                                        <div class="control-form form-group d-block col-lg-5 col-md-6 col-sm-10 col-7">
                                            ...
                                            <input type="tel" name="mobile" value="{{ $user->mobile }}"
                                                class="form-control shadow-sm border-0 " id="numPerson"
                                                aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm"
                                                placeholder="شماره را وارد کنید"
                                                pattern="(0|\+98)?([ ]|-|[()]){0,2}9[1|2|3|4]([ ]|-|[()]){0,2}(?:[0-9]([ ]|-|[()]){0,2}){8}" />
                                            <small class="errortxt float-end mt-2"></small>
                                    ...
                                    <div class="d-flex justify-content-between col-lg-12 taraz">
                                        <div class="control-form form-group d-block col-lg-5 col-md-6 col-sm-10 col-7">
                                            ...
                                            <input type="password" name="password" class="form-control shadow-sm border-0" id="password"
                                                aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm"
                                        ...
                                        <div class="control-form form-block d-block col-lg-5 col-md-6 col-sm-10 col-7">
                                            ...
                                            <input type="password" name="password_confirmation" class="form-control shadow-sm border-0" id="password2"
